    ...
    <section>
      <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-10">
              ...
              <div class="portfolio-filter">
               <center> <a href="#" class="active" data-filter="*">Online Student Verification </a></center>
			   </center>
			   <center>
        ...
        <?php 
								...
								{
									extract($_POST);
									$res = $this->Offer_model->getarray('student',"stu_roll='$student_roll' and stu_dob='$date_of_birth'  and status<>'removed'");
                    ...
                    $row = $res[0];
								...
								<div class='table-responsive'>
									...
									<a href='student_verification'><button class='btn btn-xs btn-primary'>Go Bck</button></a>
									</center>
								</div>
								</div>
								<?php 
									...
									echo "<i><h4 style='color:red' align='center' >No Record Found. Please Check Your Roll No. or Date Of Birth.</h4></i>";
									echo "<center><a href='student_verification'><button class='btn btn-xs btn-primary' style='margin-top:30px;' onClick='send' name='search' value='search'> Go Back</button></a></center>";
