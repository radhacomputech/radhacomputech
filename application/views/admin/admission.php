...
?>
                                    ...
                                    <table id="default-datatable" class="table table-bordered">
                                        <thead>
                                            <tr>
                                               ...
                                               &nbsp;<button type="button" class="btn btn-warning btn-xs  waves-effect waves-light mt-2" onClick='editNow(this)' data-name='student'>Admit</button>
                                             
                                                &nbsp; <button type="button" class="btn btn-danger btn-xs  waves-effect waves-light mt-2" data-ctrl='delete' onClick='deleteData(this)' value='Delete' data-name='student' data-load='admission'>Delete</button>
        ...
        <div class="modal-content animated zoomInUp">
            ...
            <button type="button" class="btn btn-primary btn-xs" onClick='updateData(this)' data-ctrl='update_me' data-name='student' data-load='admission' data-frm='#studentForm' value='Save Now'><i class="fa fa-check-square-o"></i> Save Now</button>
            </div>
        </div>
        </div>
    </div>
    ...
    ?>
     <script>
        $(window).on('load', function() {
            loadTable('admission', '#default-datatable');
        });
    </script>
