...
?>
        ...
        <div class="content-wrapper">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Students (O)</li>
                </ol>
            </nav>
        ...
        <div class="modal-content animated zoomInUp">
            ...
            <button type="button" class="btn btn-primary btn-xs" onClick='updateData(this)' data-ctrl='update_me' data-name='student' data-frm='#studentForm' data-load='online_student'  value='Save Now'><i class="fa fa-check-square-o"></i> Save Now</button>
            </div>
        </div>
        </div>
    </div>
    ...
    ?>
     <script>
        $(window).on('load', function() {
            loadTable('online_student', '#default-datatable');
        });
    </script>
