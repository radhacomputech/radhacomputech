                                    ...
                                    <table id="default-datatable" class="table table-bordered">
                                        <thead>
                                            <tr>
                                               ...
                                               &nbsp;<button type="button" class="btn btn-primary btn-xs  waves-effect waves-light mt-2" onClick='sessionGen(this)' data-location='student_ledger'  data-id_name='ledger_dataId' data-name='ledger_session'>Ledger</button>
                                                ...
                                                &nbsp; <button type="button" class="btn btn-dark btn-xs  waves-effect waves-light mt-2"  onClick='sessionGen(this)' data-location='registration_receipt' value='Reg. Slip' data-name='registration_session' data-id_name='registration_id'>Reg. Slip</button>
                                                 ...
                                                 <?php if($user_type=='ADMIN' or 'CLIENT'){?>
                                                 &nbsp; <button type="button" class="btn btn-dark btn-xs  waves-effect waves-light mt-2"  onClick='sessionGen(this)' data-location='print_certificate' value='Print_Certificate' data-name='registration_session' data-id_name='registration_id'>Print_Certificate</button>
                                                  <?php }?>
                                                  
                                                  
                                                    <?php if($user_type=='ADMIN' or 'CLIENT'){?>
                                                 &nbsp; <button type="button" class="btn btn-dark btn-xs  waves-effect waves-light mt-2"  onClick='sessionGen(this)' data-location='print_markssheet' value='Print_Markssheet' data-name='registration_session' data-id_name='registration_id'>Print_Markssheet</button>
                                                  <?php }?>
                                                ...
                                                <?php if($user_type=='ADMIN' or 'CLIENT'){?>
                                                &nbsp; <button type="button" class="btn btn-warning btn-xs  waves-effect waves-light mt-2"  onClick='updateResult(this)' value='Result' data-modal='result'>Result</button>
                                                <?php }?>
            ...
            <form id='studentForm'>
                ...
                <div class="col-md-4">
                                        <div class='form-group'>
                                            ...
                                            ?>
                                            <input type='date' name='stu_reg_date' id='stu_reg_date' class='form-control' value='<?php echo date('Y-m-d');?>' <?php if($permission!="YES") {echo "readonly";}?> required  >
                                        </div>
                                        <div class="form-group">
                                            <label>Select Center Code </label>
											 <select class="form-control" name='center_id' id='center_id' onChange='fillRegNo()' required>
										...
										<div class="form-group">
                                            ...
                                            <select class="form-control" name='stu_course' id='stu_course' required>
                                            <option value=''>---- Select One ----</option>
                                               <?php 
                                               $course_string = $this->Offer_model->multitableinfo('center_details',"status not in('removed','EMPTY')","assigned_courses");
                                               if($course_string<>'')
                                               {
					...
					<div class="col-md-4">
						...
						<div class="col-md-4">
										...
										<div class="form-group">
                                            <label>Address </label>
                                            <textarea class="form-control" rows="3" id='stu_address' name='stu_address'></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" id='student_photo' class='form-control' accept='image/*' data-name='student' data-category='photo' display-tag='#dispPhoto' capture='camera'>
                                        </div>
    ...
    ?>
     <script>
        $(window).on('load', function() {
            loadTable('result', '#default-datatable');
        });
    </script>
